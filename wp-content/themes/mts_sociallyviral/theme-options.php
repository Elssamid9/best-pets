            ...
            'options'  => array(
                'enabled'  => array(
                  ...
                  'pinterest' => __('Pinterest', 'sociallyviral' ),
									'stumble'   => __('Mix', 'sociallyviral' ),
                  'email' 	  => __('Email', 'sociallyviral' ),
                ),
                'disabled' => array(
									'whatsapp' 	=> __('WhatsApp', 'sociallyviral' ),
									'telegram'  => __('Telegram', 'sociallyviral' ),
									'tumblr'    => __('Tumblr', 'sociallyviral' ),
									'pocket'    => __('Pocket', 'sociallyviral' ),
									'buffer'    => __('Buffer', 'sociallyviral' ),
									'vkontakte' => __('Vkontakte', 'sociallyviral' ),
                ),
            ),
            'std'  => array(
                'enabled'  => array(
