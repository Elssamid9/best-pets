	...
	<div id="header">
		<div class="logo">
			<?php if ( get_theme_mod( 'simplyblack_logo' ) ) : ?>
				<?php if ( get_theme_mod( 'simplyblack_logo_width' ) ) {
					$logo_width = 'style="width:'.get_theme_mod( 'simplyblack_logo_width' ).'px;"';
				} else {
					$logo_width = '';
				} ?>
				<a href='<?php echo esc_url( home_url( '/' ) ); ?>' title='<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>' rel='home'>
				<img src='<?php echo esc_url( get_theme_mod( 'simplyblack_logo' ) ); ?>' <?php echo $logo_width; ?> alt='<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>'></a>
			<?php else : ?>
		...
		<?php if ( has_nav_menu( 'primary' ) ) : ?>
			...
			<div class="mobile-nav-container">
				<button id="mobile-nav-toggle" class="mobile-nav-toggle"><?php _e( 'Menu', 'simplyblack' ); ?><?php _e( ' +', 'simplyblack' ); ?></button>
